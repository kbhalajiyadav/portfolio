...
Raw Force Data(Noisy &amp; Unreliable)
PreprocessingData Cleaning &amp; UnitConversion
Baseline CorrectionNormalize Starting Force to0N
Identify Steady-StateWindow
Peak &amp; TroughDetectionIsolate Initiation Forces(Fci)
Calculate Stability MetricsPSI = Fmean / SigmaF
Summary ReportMetrics: Gci, PSI
Key Contribution: This automation reduced data processing time by 40% while ensuring that only mechanically stable (Category II) adhesives are selected for the final medical device.
4. The Result
Presented findings at ACS Fall 2025 (Washington, D.C.)
