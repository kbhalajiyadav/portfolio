...
- Added immutable action SHA pins, verified Hugo checksums, exact direct npm audit-tool versions, external-link checks, Pa11y, mobile/desktop Lighthouse, failure artifacts, and a post-deployment smoke test.
